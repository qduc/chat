...
describe('Conversations API', () => {
  describe('POST /v1/conversations', () => {
    test.todo('creates a new conversation and returns 201 with id, title, model, created_at');
    test.todo('enforces max conversations per session with 429');
    test.todo('returns 501 when persistence is disabled');
  });

  describe('GET /v1/conversations', () => {
    test.todo('lists conversations for current session with pagination (cursor, limit)');
  ...
  describe('GET /v1/conversations/:id', () => {
    ...
    test.todo('returns metadata and first page of messages with next_after_seq');
