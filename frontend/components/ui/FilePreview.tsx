...
function PreviewItem({ file, progress, onRemove }: PreviewItemProps) {
  ...
  return (
    <div className="relative group rounded-lg overflow-hidden border border-slate-200 dark:border-neutral-700 bg-slate-50 dark:bg-neutral-800 p-3 min-w-[200px] max-w-[300px]">
      <div className="flex items-start gap-3">
        ...
        {onRemove && !isUploading && (
          <button
            ...
            className="flex-shrink-0 w-6 h-6 rounded-full bg-slate-200 dark:bg-slate-700 hover:bg-slate-300 dark:hover:bg-slate-600 text-slate-600 dark:text-slate-300 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity"
