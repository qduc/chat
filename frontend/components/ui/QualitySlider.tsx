...
export function QualitySlider({ value, onChange, ariaLabel, disabled, icon, className = '' }: QualitySliderProps) {
  ...
  return (
    <div className={`flex items-center gap-3 ${className}`}>
      ...
      <div className="flex flex-col gap-1 min-w-0 h-12 justify-center">
        ...
        <div className="flex items-center gap-2">
          <input
            ...
            className="flex-1 h-2 bg-slate-200 dark:bg-neutral-700 rounded-lg appearance-none cursor-pointer
